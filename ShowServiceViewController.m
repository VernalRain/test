/*	ShowServiceViewController.m
	Copyright (c) 2016, Mx EE Shhic Inc.  All rights reserved.
 */
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.defaultBTServer getCharacteristic:ch];
    [self performSegueWithIdentifier:@"readandwrite" sender:self];
    //[ProgressHUD show:@"test begin"];
    //readLock = true;
}
